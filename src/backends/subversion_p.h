...
{
	public:
		SvnDiffstatThread(SvnConnection *connection, JobQueue<std::string, DiffstatPtr> *queue);
		~SvnDiffstatThread();

		static DiffstatPtr diffstat(SvnConnection *c, svn_revnum_t r1, svn_revnum_t r2, apr_pool_t *pool);
